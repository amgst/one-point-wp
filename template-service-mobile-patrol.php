...
?>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Flexible Patrol Options</h2>
                <p class="text-gray-600 text-lg max-w-3xl mx-auto">
                    Choose the patrol frequency that best fits your security needs and budget
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-8 rounded-xl text-center">
                    ...
                    <h3 class="text-2xl font-bold text-slate-800 mb-4">Daily Patrols</h3>
                    <p class="text-gray-600 mb-6">Regular daily checks at predetermined times</p>
                ...
                <div class="bg-slate-800 text-white p-8 rounded-xl text-center transform scale-105">
                    ...
                    <h3 class="text-2xl font-bold mb-4">Hourly Patrols</h3>
                    <p class="text-gray-300 mb-6">Frequent checks for high-security areas</p>
                ...
                <div class="bg-gray-50 p-8 rounded-xl text-center">
                    ...
                    <h3 class="text-2xl font-bold text-slate-800 mb-4">Custom Schedule</h3>
                    <p class="text-gray-600 mb-6">Tailored patrol times for your specific needs</p>
                    <ul class="text-left text-gray-600 space-y-2">
                        <li class="flex items-center">
                            <i class="fas fa-check text-slate-800 mr-2"></i>
                            Your schedule
